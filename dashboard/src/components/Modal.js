  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      <div
        ...
        onClick={onClose}
      ></div>
      <div className="relative z-10 flex max-w-[40%] items-center justify-between rounded-lg bg-white">
        <button
        ...
        <div className="flex max-h-[400px] w-full flex-col justify-center overflow-auto p-6">
          {children}
        </div>
      </div>
    </div>
